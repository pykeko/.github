...
> MacOS Tahoe desktop app for crystallography & cryoEM model building: adds NCS ghost overlays, a PyMOL command language scripting modal, MCP control surface for Claude, ligand and NCS mate jumping, Coot 0.9.x-style keyboard shortcuts/defaults, and more. 
